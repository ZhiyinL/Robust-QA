...
def main():
    ...
    if args.do_train:
        ...
        if args.meta_datatype == "opt1":
            train_qas, val_qas = get_meta_dataset_opt1(args, args.train_datasets, args.train_dir, "datasets/maml1", tokenizer, 'train') # TODO: add batch_size
        elif args.meta_datatype == "opt2":
            train_qas, val_qas = get_meta_dataset_opt2(args, args.train_datasets, args.train_dir, "datasets/maml2", tokenizer, 'train') # TODO: add batch_size
        # TODO: third condition
        elif args.meta_datatype == "opt3":
            train_qas, val_qas = get_meta_dataset_opt3(args, "datasets/maml3", tokenizer) # TODO: add batch_size
        else:
